  ...
  stages {
    stage ('BUILD BIG2.C') {
      steps {
        ...
        git branch: 'main', url: 'https://github.com/Vinay-RR/make_big2_c.git', "${params.Test_Big2.C}"
        sh 'sleep 5'
      }  
    } 
    stage ('BUILD FACT.C') {
      steps {
        ...
        git branch: 'main', url: 'https://github.com/Vinay-RR/make_fact_c.git', "${params.Test_Fact.C}"
        sh 'sleep 5'
      }
    }
      }
